...
class IndieDevEngine(TransitionEngine[int, VolleyballState, int]):
    ...
    def __init__(self):
        ...
        self._arena = SlimeVolleyballSim(self.create_base_state())
    ...
    def create_base_state(self) -> VolleyballState:
        ...
        return VolleyballState({0: Slime(np.array([0, 0, 0], dtype=np.float32), np.array([0, 0, 0], dtype=np.float32), 3, False, 0), 
                                1: Slime(np.array([0, 0, 0], dtype=np.float32), np.array([0, 0, 0], dtype=np.float32), 3, False, 0)}, 
